...
import io.vertx.webproxy.ProxyRequest;
import io.vertx.webproxy.ProxyResponse;
...
public class ProxyRequestImpl implements ProxyRequest {
  ...
  ProxyRequestImpl(HttpClient client, SocketAddress target, HttpServerRequest request) {
    this(req -> {
  ...
  ProxyRequestImpl(Function<HttpServerRequest, HttpClientRequest> provider, HttpServerRequest request) {
    if (request == null) {
